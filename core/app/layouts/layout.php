...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistema de inventario | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">Sistema<b>Inventario</b></span>
        </a>
   ...
   <!-- <?php endif; ?> -->
          ...
          <?php endif; ?>
            <li class="treeview  <?php if(isset($_GET["view"]) && ($_GET["view"]=="inventary"||$_GET["view"]=="search" ||$_GET["view"]=="inventaries"||$_GET["view"]=="selectstock"||$_GET["view"]=="inventaryval"||$_GET["view"]=="dev"||$_GET["view"]=="trasps"||$_GET["view"]=="devs"||$_GET["view"]=="re"||$_GET["view"]=="traspase"||$_GET["view"]=="onetraspase"||$_GET["view"]=="onedev")){ echo "active"; }?>">
              ...
              <li><a href="./?view=inventary&stock=<?php echo StockData::getPrincipal()->id;?>">Inventario Favorito</a></li>
              <?php $stocks = StockData::getAll();?>
              <?php foreach($stocks as $p):?>
 <li> <a href="./?view=inventary&stock=<?php echo $p->id;?>"> <?php echo $p->name;?></a></li>
	<?php endforeach; ?>
            ...
            <?php if(Core::$user->kind==1):?>
              ...
              <ul class="treeview-menu">
                <li><a href="./?view=inventorylog">Inventario</a></li>
                <!-- <li><a href="./?view=sellsbycat">Por Modelos</a></li> -->
            ...
            <li class="treeview" ><a href="./?view=selectstock" class="glyphicon glyphicon-transfer"> <span> Traspasar <span></a></li>
...
<div class="login-box">
      <div class="login-logo">
        <a href="./">Sistema<b>Inventario</b></a>
      </div><!-- /.login-logo -->
