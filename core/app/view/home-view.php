...
?>
  ...
  <section class="content-header">
    ...
    <h4>Sucursal Favorito: <?php echo StockData::getPrincipal()->name;  ?></h4>
    <?php
...
<div class="row">
  ...
  <a href="./?view=inventary&stock=<?php echo StockData::getPrincipal()->id; ?>" class="btn btn-default">Sucursal Favorito</a>
  <?php foreach($stocks as $p):?>
  <a href="./?view=inventary&stock=<?php echo $p->id;?>" class="btn btn-default"> <?php echo $p->name;?></a>
	<?php endforeach; ?>
